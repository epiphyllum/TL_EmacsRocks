...
在我们进入下一个部分之间让我们来看看使用 `~/.emacs.d/init.el` 与 `~/.emacs` 的区别（更多关于他们区别的讨论可以在[这里](http://emacs.stackexchange.com/questions/1/are-there-any-advantages-to-using-emacs-d-init-el-instead-of-emacs)找到）。简单来说请使用前者它因为它有下面的两个优点，
